...
public class ComInfoListAdapter extends BaseAdapter {
    ...
    public ComInfoListAdapter(Context context, List<CommunityInfo> list, ImageLoader imageLoader){
    ...
    public ComInfoListAdapter(Context context){
        this.context = context ;
        mInflater = LayoutInflater.from(context) ;
    }
