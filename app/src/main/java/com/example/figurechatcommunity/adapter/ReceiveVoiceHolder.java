...
public class ReceiveVoiceHolder extends BaseViewHolder {
 ...
 // @Bind(R.id.tv_voice_length)
  ...
  public ReceiveVoiceHolder(Context context, ViewGroup root,OnRecyclerViewListener onRecyclerViewListener) {
    ...
    try {
      currentUid = BmobUser.getCurrentUser(UserInfo.class).getObjectId();
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public void bindData(Object o) {
    ...
    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,info != null ? info.getAvatar() : null, R.mipmap.personmodel);
