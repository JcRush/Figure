...
import com.example.figurechatcommunity.Bean.AgreeAddFriendMessage;
...
public class NewFriendAdapter extends BaseRecyclerAdapter<NewFriend> {
    ...
    public void bindView(final BaseRecyclerHolder holder, final NewFriend add, int position) {
        holder.setImageView(add == null ? null : add.getAvatar(), R.mipmap.personmodel, R.id.iv_recent_avatar);
